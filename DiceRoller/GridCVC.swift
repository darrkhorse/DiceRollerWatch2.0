...
//  DiceRoller
//
//  Created by Hinck, Johann A on 12/13/15.
...
class GridCVC: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        //self.collectionView!.registerClass(CustomCVCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    */
    ...
    //number of options in a Collection View
    ...
    */
    ...
    {
        print("About to select item at \(indexPath.row)")
        return true
    }
